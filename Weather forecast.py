...
def getWeather():
    ...
    #weather
    api = "https://api.openweathermap.org/data/3.0/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude={part}&appid=e98eeeea53a1a19115be4c0822eebda3"
    ...
    w.config(text=(wind,"m/"))
    d.config(text=(description))

    #first cell

    firstdayimage=json_data['daily'][0]['weahter'][0]['icon']
    ...
    seconddayimage = json_data['daily'][1]['weahter'][0]['icon']
    ...
    thirddayimage = json_data['daily'][2]['weahter'][0]['icon']
    ...
    fourthdayimage = json_data['daily'][3]['weahter'][0]['icon']
    ...
    fifthdayimage = json_data['daily'][4]['weahter'][0]['icon']
    ...
    sixthdayimage = json_data['daily'][5]['weahter'][0]['icon']
    ...
    seventhdayimage = json_data['daily'][6]['weahter'][0]['icon']
...
#icon
image_icon=PhotoImage(file="E:\Images\logo.png")
root.iconphoto(False,image_icon)

Round_box=PhotoImage(file="E:\Images\Rounded Rectangle 1.png")
Label(root,image=Round_box,bg="#FA5F55").place(x=30,y=110)

#label

label1=Label(root,text="Temperature", font=('Bold',11),fg="white",bg="#203243")
label1.place(x=70,y=120)

label2=Label(root,text="Humidity", font=('Bold',11),fg="white",bg="#203243")
label2.place(x=70,y=140)

label3=Label(root,text="Pressure", font=('Bold',11),fg="white",bg="#203243")
label3.place(x=70,y=160)

label4=Label(root,text="Wind Speed", font=('Bold',11),fg="white",bg="#203243")
label4.place(x=70,y=180)

label5=Label(root,text="Description", font=('Bold',11),fg="white",bg="#203243")
label5.place(x=70,y=200)

#searchbox

Search_image=PhotoImage(file="E:\Images\Rounded Rectangle 3.png")
myimage=Label(image=Search_image,bg="#FA5F55")
myimage.place(x=270,y=120)



weat_image=PhotoImage(file="E:\Images\Layer 7.png")
...
Search_icon=PhotoImage(file="E:\Images\Layer 6.png")
...
firstbox=PhotoImage(file="E:\Images\Rounded Rectangle 2.png")
secondbox=PhotoImage(file="E:\Images\Rounded Rectangle 2 copy.png")
...
#clock
clock=Label(root,font=("Helvetica",30,'bold'),fg="white",bg="#FA5F55")
clock.place(x=30,y=20)

# timezone

timezone=Label(root,font=("Helvetica",20),fg="white",bg="#FA5F55")
timezone.place(x=700,y=20)

long_lat=Label(root,font=("Helvetica",10),fg="white",bg="#FA5F55")
...
day1temp=Label(firstframe,bg="#282829",fg="#FA5F55",font="arial 15 bold")
